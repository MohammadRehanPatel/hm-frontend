...
import { FaLaptopMedical, FaBed } from "react-icons/fa";
...
const ServiceCard = ({ title, description, icon }) => {
  ...
  return (
    <div>
      <div class="relative isolate bg-cyan-400 pb-10 pt-10 sm:pt-32">
        <div
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          {servicesData.map((service, index) => (
            <figure class="rounded-2xl flex file: bg-white shadow-lg ring-1 ring-gray-900/5 sm:col-span-2 xl:col-start-2 xl:row-end-1">
              ...
              <figcaption class="flex flex-wrap items-center gap-x-4 gap-y-4 border-t border-gray-900/10 px-6 py-4 sm:flex-nowrap">
                ...
                {/* className={`h-10 w-10 flex-none rounded-full bg-gray-50 fa-solid ${service.icon}`}
                /> */}
